...
function About() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed='-0.2' className='w-full p-20 bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl text-black'>
        ...
        <div className='w-full border-t-[1px] flex gap-5 pt-10 mt-20 border-[#a1b562]'>
            ...
            <div className='w-1/2 h-[70vh] bg-[#4f6111] rounded-3xl'>
                <img className = 'h-full w-full rounded-3xl'src="https://ochi.design/wp-content/uploads/2022/05/Homepage-Photo-663x469.jpg" alt="" />
            </div>
        </div>
    </div>
  )
